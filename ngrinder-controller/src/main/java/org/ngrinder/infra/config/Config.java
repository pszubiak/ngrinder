...
public class Config extends AbstractConfig implements ControllerConstants, ClusterConstants,
	...
	public synchronized void loadProperties() {
		...
		System.setProperty("ngrinder.lib.path", getCurrentUnpackedFolder());

		clusterProperties = new PropertiesWrapper(properties, clusterPropertiesKeyMapper);
	}

	private String getCurrentUnpackedFolder() {
		return new File(((URLClassLoader) getClass().getClassLoader()).getURLs()[1].getFile()).getParentFile().getAbsolutePath();
	}
